...
const BASE_TRAINING_CHARACTERS: Character[] = [
  ...
  },
  {
    ...
    lifeStory: {
      ...
      adulthood: [
        '如今十五岁的雫已经是一名经验丰富的冒险者。她跟随那位战士讨伐了无数哥布林巢穴，见证了太多女性被哥布林蹂躏的悲惨景象。这些经历让她变得更加坚定，也更加明白哥布林的威胁有多么可怕。但在某次讨伐行动中，她与那位战士走散了。她被一群哥布林包围，尽管她拼命战斗，但最终还是被俘虏了。现在她被带到了古拉尔大陆的一个哥布林巢穴中，成为了囚犯。她知道哥布林会对她做什么，她见过太多这样的受害者。她只能在心中默默祈祷，希望那位战士能够找到她，希望女神能够保佑她。',
      ],
      currentState: [
        '雫被关押在巢穴的牢房中，她的神官袍被撕破了一角，锁子甲也被剥下。她的左肩上还有当年被毒箭射中留下的伤疤，现在这个伤疤似乎在提醒她，她又一次陷入了绝境。她不知道那位战士是否知道她被俘虏了，也不知道他是否会来救她。她只能等待，等待命运的审判。她知道，如果她无法逃脱，她将会面临比死亡更可怕的命运。',
      ],
    },
    ...
    appearance: {
      ...
      cupSize: 'B',
      description:
        '雫的身材娇小纤细，如同尚未完全绽放的花蕾。她拥有一头如阳光般灿烂的金色长发，发丝柔顺而富有光泽，通常垂至腰间，几缕碎发自然地垂落在脸颊两侧，为她增添了一丝少女的柔美。她的肌肤白皙如雪，细腻娇嫩，仿佛从未经历过风霜雨露的摧残，在光线下泛着淡淡的珍珠般的光泽。她的五官精致可爱，眉毛纤细而自然，高挺的鼻梁下是一张樱桃小嘴，总是抿着，透露着少女的青涩和不安。她最引人注目的是那双如天空般清澈的蓝色眼眸，眼神中既有少女的纯真也有神官的虔诚，睫毛纤长而卷翘，在脸上投下淡淡的阴影。她的颈项修长优雅，锁骨精致而突出，乳房刚刚发育，娇小而挺拔，被朴素的神官袍遮掩着。她的腰肢纤细，盈盈不足一握，被厚重的法袍完全掩盖。臀部小巧圆润，曲线柔和，修长纤细的双腿穿着白色长筒袜和棕色的长筒靴，看起来就像一个虔诚的神职人员。她的手指纤细修长，从未做过重活，保养得极好，指甲修剪整齐，呈现健康的粉色。她的左肩膀上有一道淡淡的伤疤，那是被哥布林毒箭射中留下的印记，这是她成长历程的见证。在法袍下，她穿着锁子甲防身，这是她跟随那位战士后养成的习惯。她总是保持着一个神官应有的端庄和虔诚，但现在她不知道自己能否继续保持这样的形象。',
      clothing: {
        head: '神官帽子',
        top: '白色的神官袍',
        bottom: '白色的神官长裙',
