...
const BASE_TRAINING_CHARACTERS: Character[] = [
  ...
  },
  {
    ...
    corruptedAvatar: 'https://kitakamis.online/hero_portaits/精灵女王1.png',
    fullyCorruptedAvatar: 'https://kitakamis.online/hero_portaits/精灵女王1.png',
    status: 'surrendered',
    canCombat: true,
    unitType: 'magical',
    loyalty: 100,
    ...
    background: '王族',
    sexExperience:
      '艾瑟莉娅作为月光女王，拥有数千年的生命和至高无上的权力。在永恒精灵的文化中，女王被视为特拉希尔女神的化身，她们的贞洁被视为神圣的象征。艾瑟莉娅从未与任何男性有过亲密关系，她的身体保持着处女般的纯洁状态。然而，作为永恒精灵，她天生具有强烈的生命魔法能力，这种能力让她在保持贞洁的同时，也能感受到内心深处对生命的热爱。她的生命魔法能力让她能够创造出各种治愈效果，包括性感的幻象，但她从未真正体验过真实的肉体接触。',
    sensitivePoints: ['胸部'],
    sensitivePointsDetail: [
      {
        part: '嘴巴',
        isSensitive: false,
        description:
          '艾瑟莉娅的嘴唇饱满而性感，呈现自然的淡粉色，如同樱花花瓣般柔嫩。她的唇形完美，上唇略薄而下唇丰盈，接吻时会有微微的颤抖。她的舌头灵活而湿润，口腔内部温暖紧致，当被深入侵犯时会本能地吸吮和纠缠。永恒精灵的唾液具有轻微的甜味，据说能够治愈轻微的伤口。',
      },
      {
        part: '胸部',
        isSensitive: true,
        description:
          '艾瑟莉娅的胸部丰满挺拔，H罩杯的乳房在紧身女王装束下展现出完美的形状。她的乳房触感柔软却富有弹性，乳晕呈现淡粉色，直径约三厘米，乳头在未受刺激时呈现可爱的粉红色。由于永恒精灵的体质特殊，她的乳房保持着极佳的形状，几乎没有下垂。当被抚摸时，乳头会迅速充血变硬，整体敏感度极高，这是她最大的弱点之一。',
      },
      {
        part: '阴道',
        isSensitive: false,
        description:
          '艾瑟莉娅的阴道因为从未有过性经验而保持着处女般的紧致度。外阴唇饱满而富有弹性，内阴唇小巧粉嫩，阴蒂隐藏在包皮之下。阴道内壁布满细密的褶皱，收缩力极强，在被插入时会本能地紧紧吸附。永恒精灵的阴道具有特殊的生命能量，能够感知到对方的生命状态，但阴道本身的敏感度一般。',
      },
      {
        part: '子宫',
        isSensitive: false,
        description:
          '艾瑟莉娅的子宫保持着永恒精灵的原始状态，从未被任何异物触碰过。她的子宫口紧闭，内部温度正常，当被精液灌满时会产生强烈的满足感。永恒精灵的子宫具有特殊的生命魔法，能够感知到生命的诞生，作为女王，她的子宫还具有特殊的净化能力，但敏感度并不算高。',
      },
      {
        part: '后庭',
        isSensitive: false,
        description:
          '艾瑟莉娅的后庭紧致而从未被开发过，臀部饱满圆润，臀肉紧实而富有弹性。她的肛门呈现健康的浅粉色，周围皮肤细腻光滑。由于从未有过这方面的经验，她的后庭保持着完全的紧闭状态，即使是手指也难以轻易进入。她对这个部位有着本能的抗拒和羞耻感，认为从后方被侵犯是极度屈辱的行为，特别是被哥布林这种低等生物侵犯。',
      },
    ],
    lifeStory: {
      childhood: [
        '艾瑟莉娅出生于世界树圣域的月冠殿，是永恒精灵皇室家族的长女。从小她就被灌输着统治世界树和特拉希尔女神的理念，在父母的严格训练下，她学会了生命魔法、政治学和军事指挥。在那个充满神圣的童年里，她目睹了月冠殿的壮丽和永恒精灵皇室文明的辉煌，这让她从小就立志要成为一名女王，保护世界树和特拉希尔女神的荣耀。她的母亲是一位资深女王，教会了她高级的政治知识，这为她后来成为女王奠定了基础。',
      ],
      adolescence: [
        '一百岁时，艾瑟莉娅正式加入了月冠殿的政治组织，成为了一名见习女王。在政治组织中，她以优异的政治天赋和坚定的意志赢得了同僚们的尊重。一百二十岁时，她参加了第一次对黑暗精灵的防御战，在战斗中表现出色，被提升为小队长。一百五十岁时，她率领自己的小队成功击退了黑暗精灵对月冠殿的袭击，因此被授予了月冠女王的称号。那段时期是她人生中最充实的时光，她与战友们并肩作战，为保护世界树的安全而奋斗。',
      ],
      adulthood: [
        '二百岁时，艾瑟莉娅被任命为月冠殿的女王，负责管理整个永恒精灵的政治事务。作为女王，她不仅要管理政治，还要管理永恒精灵的日常事务，协调与各据点的合作。她以铁腕手段管理着永恒精灵，用雷霆手段镇压了数次外敌的入侵。在血与火的洗礼中，她从一个年轻的女王成长为一位成熟的领袖，向所有人证明了永恒精灵同样可以成为优秀的政治领袖。',
      ],
      currentState: [
        '如今八百岁的艾瑟莉娅已经担任女王六百多年，她将永恒精灵管理得井井有条，甚至开始向周边地区扩张势力。但作为女王，她也面临着来自各方的威胁和挑战。夜深人静时，她常常会想念故乡的亲人，但为了特拉希尔女神的荣耀，她必须坚守在这个神圣的岗位上。最近哥布林的活动越来越频繁，她预感到一场更大的战斗即将来临，为此她加强了月冠殿的防御，同时派出侦察兵侦查哥布林巢穴的动向。她不知道的是，她的美貌和身份已经让她成为了哥布林王风花的重点目标。',
      ],
    },
    personality: ['高贵神圣', '智慧深邃', '外冷内热'],
    fears:
      '艾瑟莉娅最大的恐惧是失去特拉希尔女神的庇护和让无辜的精灵受到伤害。作为女王，她深知每一次决策都关系到精灵们的生死。她害怕因为自己的失误而导致精灵牺牲，害怕无法保护那些信任她的族人。这种恐惧驱使她必须时刻保持警惕，绝不在任何战斗中掉以轻心。',
    secrets:
      '艾瑟莉娅的秘密是她内心深处对爱情的渴望和对被保护的渴望。作为女王，她必须时刻保持神圣，但内心深处她渴望有一个能够保护她、理解她的男人。这个秘密让她既困扰又羞耻，她害怕被人发现这个弱点，害怕被人认为她不够神圣。',
    appearance: {
      height: 185,
      weight: 68,
